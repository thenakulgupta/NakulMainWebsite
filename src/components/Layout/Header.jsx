...
import { headerData } from "../Sections/MyInfo";
	...
	return (
		<>
			...
			>
				...
				<Link to="/" className="site-title ms-2">
					{headerData.name}
				</Link>
			</div>
			...
			>
				...
				<div
					className="header-inner d-flex align-items-start flex-column"
                  ...
                  <Link to="/">
					...
					<div className="footer mt-auto">
						<ul className="social-icons list-inline">
							...
							{!headerData.social.leetcode ? null : (
								<li className="list-inline-item">
									<a
										href={headerData.social.leetcode}
										target="_blank"
										rel="noreferrer"
									>
										<FaCode />
